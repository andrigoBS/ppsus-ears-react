...
const RegisterMother = ({register, errors}) => {
    return (
        <Fragment>
            ...
            <Grid item xs={12} sm={12} md={6}>
                <BrazilianPhoneField register={register} name="motherPhonePrimary" error={errors.phonePrimary}
                                     label="Telefone Residencial" variant="outlined" size="small" sx={styles.textField} required
                />
            </Grid>
            <Grid item xs={12} sm={12} md={6}>
                <BrazilianPhoneField register={register} name="motherPhoneSecond" error={errors.phoneSecond}
