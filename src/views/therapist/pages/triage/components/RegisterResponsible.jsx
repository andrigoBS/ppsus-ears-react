...
const RegisterResponsible = ({ register, errors }) => {
    ...
    return (
        <Fragment>
            ...
            <BaseRegisterResponsible register={register} errors={errors} prefixName={'mother'} states={states}/>
            {responsibleCount > 0 &&
                <Grid item xs={12} sm={12} md={12}>
            ...
            {Array(responsibleCount).fill(0).map((zero, index) => (
                <Fragment key={`responsible-${index}`}>
                    ...
                    <BaseRegisterResponsible register={register} errors={errors} prefixName={`responsible.${index}`} states={states}/>
                </Fragment>
            ))}
            <Grid item xs={12} sm={12} md={12}>
